...
public class SinglyLinkedList<E> implements LList<E> {
	...
	/**
	 * Returns an array representation of the list If a list contains A, B, and C,
	 * the following should be returned {A, B, C}, If a list contains A, B, C, and C
	 * the following should be returned {A, B, C, C}
	 *
	 ...
	 * order
	 *
	 * @return a boolean of whether two lists have the same contents, item per item
